...
#                            - Cleaned up code
# v3.0 09APR06  KC6HUR  aprs_status_tx.pl completely rewritten to
...
# v4.0 10APR07  KC6HUR  Did away with the aprs_status_tx.pl program
#               KF7FLY  and modified aprs_status to use netcat (nc)
...
36 * * * * (/home/irlp/custom/aprs_status >/dev/null 2>&1)
...
The 3.x version of the aprs_status program no longer requires that you
...
OPERATION
=========
The aprs_status script is called periodically (60 minutes) from 
...
5. Next configure the aprs_status.conf file as described below.
...
Each entry has comments within the aprs_status.conf file describing 
what is required.
...
3. When editing the aprs_status.conf, the 5-digit code obtained in the
...
==========================
To update your custom cron to schedule running aprs_status script 
